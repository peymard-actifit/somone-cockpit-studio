...
export const DEFAULT_TRANSLATIONS: Record<string, { FR: string; EN: string }> = {
  ...
  'modal.welcomeMessagePlaceholder': { FR: 'Ce message sera affiché aux visiteurs lors de l\'ouverture du cockpit publié...', EN: 'This message will be displayed to visitors when opening the published cockpit...' },
  'modal.editWelcomeMessage': { FR: 'Modifier le message d\'accueil', EN: 'Edit welcome message' },
